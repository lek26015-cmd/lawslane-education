        ...
        <Link href={href || `/courses/${course.id}`} className="group block h-full">
            <div className="flex flex-col h-full bg-white border border-slate-100 rounded-2xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="flex-1 p-4 flex flex-col gap-3">
                    ...
                    {/* Title */}
                    <h3 className="font-bold text-lg text-slate-800 line-clamp-2 leading-snug group-hover:text-[#0B3979] transition-colors -mt-1">
                        {course.title}
                    </h3>
                    ...
                    {course.instructor && (
                        <div className="flex items-center gap-2 mt-auto pt-2">
                            {course.instructor.avatarUrl ? (
                                ...
                                <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center text-[10px] font-bold text-[#0B3979]">
