            ...
            <Tabs defaultValue="exams" className="w-full space-y-6">
                ...
                <TabsContent value="ebooks" className="space-y-6 animate-in slide-in-from-bottom-2 duration-500">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {ebooks.filter(item => item.type !== 'COURSE' && !item.title?.toLowerCase().includes('course') && !item.title?.includes('คอร์ส')).length > 0 ? (
                ...
                <TabsContent value="courses" className="space-y-6 animate-in slide-in-from-bottom-2 duration-500">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {ebooks.filter(item => item.type === 'COURSE' || item.title?.toLowerCase().includes('course') || item.title?.includes('คอร์ส')).length > 0 ? (
                            ...
                            <div className="col-span-full border-dashed border-2 bg-slate-50/50 rounded-2xl p-12">
