                                                ...
                                                <>
                                                    ...
                                                    {answer.correctAnswer && (
                                                        <div className="bg-blue-50 rounded-lg p-4">
                                                            <p className="text-sm font-medium text-[#082a5a] mb-1">📚 ธงคำตอบ</p>
                                                            <p className="text-blue-900 whitespace-pre-wrap text-sm">{answer.correctAnswer}</p>
                                                        </div>
                                                    )}
                                                    ...
                                                    <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-lg p-4">
                                                        <div className="flex items-center gap-2 mb-2">
                                                            <Sparkles className="w-4 h-4 text-[#0B3979]" />
                                                            <p className="text-sm font-medium text-[#082a5a]">AI Feedback</p>
                                                        </div>
